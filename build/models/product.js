...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO products (pname, price) VALUES($1, $2) RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [p.pname, p.price])];
                    case 2:
                        result = _a.sent();
    ...
    ProductStore.prototype.edit = function (id, p) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'UPDATE products SET pname=$1, price=$2 WHERE id=$3 RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [p.pname, p.price, id])];
                    case 2:
                        result = _a.sent();
                        product = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update product ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
