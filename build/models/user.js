...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.edit = function (id, u) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'UPDATE users SET firstname=$1, lastname=$2, email=$3, password=$4 WHERE id=$5 RETURNING id, firstname, lastname, email';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [
    ...
    UserStore.prototype.authenticate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var pepper, sql, sql2, conn, result, user, userInfo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        ...
                        sql2 = 'SELECT id, firstname, lastname, email FROM users WHERE email=($1)';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 2:
                        ...
                        user = result.rows[0];
                        if (!bcrypt_1.default.compareSync(password + pepper, user.password)) return [3 /*break*/, 4];
                        return [4 /*yield*/, conn.query(sql2, [email])];
                    case 3:
                        userInfo = _a.sent();
                    ...
                    case 5:
                        error_1 = _a.sent();
                        throw new Error("Can not login: ".concat(error_1.message));
