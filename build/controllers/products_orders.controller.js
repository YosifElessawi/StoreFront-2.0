...
var store = new product_order_1.Product_OrderStore();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product_order, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.edit(req.params.id, req.body)];
            case 1:
                product_order = _a.sent();
                res.json({
                    status: 'Successful',
